        ...
        fields={{
          data: {
            ...
            "benchling_extraction_type": {
              ...
              description: "The type of genetic material extracted from the source sample",
            },
        ...
        fields={{
          data: {
            ...
            "tolqc_reporting_category": {
              ...
              description: "The assembly data type being reported on for this sample, such as the sequencing platform or method (e.g. PacBio, HiC)",
            },
            ...
            "tolqc_bases": {
              description: "Total yield of genetic material in an extraction based on the number of bases counted",
            },
          },
          order: {
            active: [
      ...
      <RemoteTable
        ...
        fields={{
          data: {
            ...
            "grit_species_name": {
              rename: "Species Name",
              description: "For a taxon with rank species, this will be the same as the scientific name",
            },
            "grit_created": {
              rename: "Created",
            },
