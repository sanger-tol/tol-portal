...
function TUMSteps() {
  ...
  useTranslator({
    ...
    translations: {
      ...
      "calc_coverage_estimated": "benchling_tolid.calc_coverage_estimated",
      ...
      "calc_coverage_estimated_met": "benchling_tolid.calc_coverage_estimated_met",
  ...
  const libraryRemainingTable = (
    <RemoteTable
      ...
      fields={{
        ...
        "benchling_tolid.calc_coverage_estimated": {},
    ...
    components: [
      {
        ...
        filter: {
          and_: {
            ...
            'calc_sequencing_request_calc_mlwh_volume_remaining_max': {'lte': {'value': 0.0}},
    ...
    components: [
      {
        ...
        filter: {
          and_: {
            ...
            'calc_sequencing_request_calc_mlwh_volume_remaining_max': {'lte': {'value': 0.0}}, 
            'calc_extraction_calc_benchling_volume_ul_dna_max': {'lte': {'value': 0.0}},
    ...
    components: [
      {
        ...
        filter: {
          and_: {
            ...
            'calc_sequencing_request_calc_mlwh_volume_remaining_max': {'lte': {'value': 0.0}}, 
            'calc_extraction_calc_benchling_volume_ul_dna_max': {'lte': {'value': 0.0}},
            'calc_tissue_prep_calc_benchling_weight_mg_max': {'lte': {'value': 0.0}},
    ...
    components: [
      {
        ...
        filter: {
          and_: {
            'sts_tissue_remaining': {'gt': {'value': 0.0}},
            'sts_eln_id': {'exists': {'negate': true }},
            'calc_sequencing_request_calc_mlwh_volume_remaining_max': {'lte': {'value': 0.0}}, 
            'calc_extraction_calc_benchling_volume_ul_dna_max': {'lte': {'value': 0.0}},
            'calc_tissue_prep_calc_benchling_weight_mg_max': {'lte': {'value': 0.0}},
            'calc_benchling_remaining_weight': {'lte': {'value': 0.0}},
  ...
  const sampleRemainingSTSTable = (
    <RemoteTable
      ...
      fields={{
        ...
        "sts_tolid.calc_coverage_estimated": {},
        "sts_organism_part":{},
        "sts_tissue_size": {},
        "sts_sex": {},
        "benchling_species.goat_ploidy": {},
