      ...
      fields={{
        ...
        order: {
          active: [
            ...
            "extraction_container_dna_count",
          ],
        },
      }}
    ...
    components: [
      {
        ...
        filter: {
          and_: {
            ...
            'extraction.extraction_type': { 'in_list': { 'value': ['dna', 'lres'] } },
      ...
      fields={{
        order: {
          active: [
            ...
            "sequencing_request_pacbio_count",
            "sequencing_request_pacbio_completed_count",
            "calc_ongoing_submissions",
            "species.genome_size",
            "gscope_coverage",
            "calc_coverage",
