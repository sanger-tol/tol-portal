...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('data_source_config_id', sa.Integer, sa.ForeignKey('data_source_config_attribute.data_source_config_id'), nullable=False, server_default='1'),
    )

    # elastic_extraction_summariser.load_sequencing_request_stats()
    op.execute('INSERT INTO data_source_config_summary (source_object_type, destination_object_type, object_filters, group_by, stats_fields, stats, prefix) '
